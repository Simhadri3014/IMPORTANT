...
public class IntegerFormatValidator
{
	...
	/**
	  * Validates whether the input is integer or not
	  * @param input: is to validate whether it is an integer or not
	  * @return it returns an true if it is the Valid Integer, Otherwise flase
	 */
	public boolean isInteger(String input)
	{
		try
		{
			int intputNumber = Integer.parseInt(input);
			return true;
		}
