...
/**
  * PrimeNumberCounter is the main class for checking the PrimeNumbers up to the given number
...
{
	private static final Logger logger = LogManager.getLogger(PrimeNumberCounter.class);
	...
	/**
	  ...
	  * Inthe for loop making the variable name as counter
